...
public class CatalogoProfesorRestController {
	...
	public ResponseEntity<JSONResponse> listCatalogoProfesor(
			@RequestParam(defaultValue = "RELEVANTE", name = "orden") OrdenCatalogo filtro,
			@RequestParam(required = false, name = "idMateria") Long idMateria,
			@RequestParam(required = false, name = "idNivel") Integer idNivel) throws BusinessException {
	...
	public ResponseEntity<JSONResponse> getCatalogoProfesor(@PathVariable("id") Long idProfesor)
	...
	public ResponseEntity<JSONResponse> getCatalogoCalificacion(@PathVariable("id") Long idProfesor)
			throws BusinessException {
	...
	public ResponseEntity<JSONResponse> getCatalogoHorario(@PathVariable("idProfesor") Long idProfesor,
			@PathVariable("fecha") String fecha) throws BusinessException {
	...
	public ResponseEntity<JSONResponse> getCatalogoConsultas(@PathVariable("id") Long idProfesor)
			throws BusinessException {
