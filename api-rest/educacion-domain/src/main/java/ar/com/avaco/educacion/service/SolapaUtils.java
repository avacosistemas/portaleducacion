...
public class SolapaUtils {
	...
	public static boolean seSolapan(Date dia1, Date dia2, Integer hora1, Integer hora2, int duracionClase) {
		...
		if (dia1.toString().equals(dia2.toString())) {
			...
			LocalTime aula1LT = LocalTime.parse(hora1.toString() + ":00:00", DateTimeFormatter.ISO_LOCAL_TIME);
			LocalTime aula2LT = LocalTime.parse(hora2.toString() + ":00:00", DateTimeFormatter.ISO_LOCAL_TIME);
