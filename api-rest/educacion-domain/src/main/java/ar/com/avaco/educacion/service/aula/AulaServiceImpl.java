...
public class AulaServiceImpl extends NJBaseService<Long, Aula, AulaRepository> implements AulaService {
	...
	public boolean seSolapan(Date dia1, Date dia2, String hora1, String hora2, int duracionClase) {
		...
		if (dia1.toString().equals(dia2.toString())) {
			...
			LocalTime aula1LT = LocalTime.parse(hora1);
			LocalTime aula2LT = LocalTime.parse(hora2);
